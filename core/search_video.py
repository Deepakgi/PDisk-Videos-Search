...
search_api = "https://doodapi.com/api/search/videos?dir_id=-1&item_id=&title={}&pageSize=10&pageNo=1&desc=&status=&sortField=ctime&sortAsc=0&needDirName=true"


async def videos(query: str, username: str, password: str) -> Union[dict, Exception]:
    try:
        ...
        if data["msg"] == "Please login again":
            ...
            return await videos(query, username, password)
        else:
            return data
